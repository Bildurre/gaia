...
function gaia_social_links() {
  ...
  foreach ($social_links as $network => $url) {
    printf(
      '<li class="social-links__item"><a href="%s" class="social-links__link social-links__link--%s" target="_blank" rel="noopener noreferrer"><span class="screen-reader-text">%s</span>%s</a></li>',
      esc_url($url),
      esc_attr($network),
